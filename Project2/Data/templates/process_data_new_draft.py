...
def load_data(messages_filepath, categories_filepath):
    ...
    Parameters:
    messages_filepath: messages csv path
    categories_filepath: categories csv path
    
    Returns:
    df: dataframe containing messages.csv and categories.csv merged
    
    """
    # load datasets
    messages = pd.read_csv('disaster_messages.csv')
    categories = pd.read_csv('disaster_categories.csv', sep = ',')
